...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"LeviLauncher","description":"User documentation for LeviLauncher, a desktop launcher for Minecraft Bedrock Edition (GDK) on Windows.","base":"/LeviLauncher/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":"/appicon.png","search":{"provider":"local"},"socialLinks":[{"icon":"github","link":"https://github.com/LiteLDev/LeviLauncher"}],"footer":{"message":"Built for licensed Minecraft Bedrock (GDK) players on Windows.","copyright":"Copyright © 2024-2026 LeviMC"}},"locales":{"root":{"label":"English","lang":"en-US","link":"/","themeConfig":{"nav":[{"text":"Guide","link":"/guide/quick-start"},{"text":"Releases","link":"https://github.com/LiteLDev/LeviLauncher/releases"},{"text":"Mirror","link":"https://levimc.lanzoue.com/b016ke39hc"},{"text":"Community","link":"https://discord.gg/v5R5P4vRZk"},{"text":"GitHub","link":"https://github.com/LiteLDev/LeviLauncher"}],"sidebar":{"/guide/":[{"text":"Quick Start","items":[{"text":"Get Started in 5 Minutes","link":"/guide/quick-start"},{"text":"Requirements & Installation","link":"/guide/requirements-installation"},{"text":"First Launch","link":"/guide/first-launch"}]},{"text":"Core Workflows","items":[{"text":"Version Management","link":"/guide/version-management"},{"text":"Downloads & Mirrors","link":"/guide/downloads-mirrors"},{"text":"Content Management","link":"/guide/content-management"}]},{"text":"Advanced Features","items":[{"text":"Mods & Integrations","link":"/guide/mods-integrations"},{"text":"World Tools","link":"/guide/world-tools"},{"text":"Settings & Personalization","link":"/guide/settings-personalization"}]},{"text":"Help","items":[{"text":"Update & Troubleshooting","link":"/guide/update-troubleshooting"},{"text":"FAQ, Community & Feedback","link":"/guide/faq-community-feedback"}]}]},"outline":{"level":[2,3]},"docFooter":{"prev":"Previous page","next":"Next page"},"editLink":{"pattern":"https://github.com/LiteLDev/LeviLauncher/edit/main/docs/:path","text":"Edit this page on GitHub"},"returnToTopLabel":"Back to top","sidebarMenuLabel":"Menu","darkModeSwitchLabel":"Appearance","lightModeSwitchTitle":"Switch to light theme","darkModeSwitchTitle":"Switch to dark theme"}},"zh-CN":{"label":"简体中文","lang":"zh-CN","link":"/zh-CN/","themeConfig":{"nav":[{"text":"文档","link":"/zh-CN/guide/quick-start"},{"text":"下载","link":"https://github.com/LiteLDev/LeviLauncher/releases"},{"text":"蓝奏云","link":"https://levimc.lanzoue.com/b016ke39hc"},{"text":"社区","link":"https://discord.gg/v5R5P4vRZk"},{"text":"GitHub","link":"https://github.com/LiteLDev/LeviLauncher"}],"sidebar":{"/zh-CN/guide/":[{"text":"快速开始","items":[{"text":"5 分钟上手","link":"/zh-CN/guide/quick-start"},{"text":"系统要求与安装","link":"/zh-CN/guide/requirements-installation"},{"text":"首次启动","link":"/zh-CN/guide/first-launch"}]},{"text":"核心功能","items":[{"text":"版本管理","link":"/zh-CN/guide/version-management"},{"text":"下载与镜像","link":"/zh-CN/guide/downloads-mirrors"},{"text":"内容管理","link":"/zh-CN/guide/content-management"}]},{"text":"高级能力","items":[{"text":"Mods 与集成","link":"/zh-CN/guide/mods-integrations"},{"text":"世界工具","link":"/zh-CN/guide/world-tools"},{"text":"设置与个性化","link":"/zh-CN/guide/settings-personalization"}]},{"text":"帮助","items":[{"text":"更新与故障排查","link":"/zh-CN/guide/update-troubleshooting"},{"text":"常见问题、社区与反馈","link":"/zh-CN/guide/faq-community-feedback"}]}]},"outline":{"level":[2,3]},"docFooter":{"prev":"上一页","next":"下一页"},"editLink":{"pattern":"https://github.com/LiteLDev/LeviLauncher/edit/main/docs/:path","text":"在 GitHub 上编辑此页"},"returnToTopLabel":"返回顶部","sidebarMenuLabel":"菜单","darkModeSwitchLabel":"外观","lightModeSwitchTitle":"切换到浅色主题","darkModeSwitchTitle":"切换到深色主题"}}},"scrollOffset":134,"cleanUrls":true}'));
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.Yf_Oy0I6.js"));
