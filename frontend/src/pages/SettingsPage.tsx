              ...
              {selectedTab === "general" && (
                <div className="flex flex-col gap-6">
                      ...
                      >
                        <ListBox className={COMPONENT_STYLES.select.listbox}>
                          <ListBox.Item
                            id="minimize"
                            textValue={t(
                              "settings.game_behavior.on_launch_minimize",
                            )}
                          >
                            <Label>
                          ...
                          <ListBox.Item
                            id="close"
                            textValue={t(
                              "settings.game_behavior.on_launch_close",
                            )}
                          >
                            <Label>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      aria-label={t("settings.game_behavior.minimize_to_tray")}
                      size="sm"
                      isSelected={minimizeToTray}
                      onChange={(isSelected: boolean) => {
                        setMinimizeToTray(isSelected);
                      }}
                      className={"group"}
                    >
                      <Switch.Content>
