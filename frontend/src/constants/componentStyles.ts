export const COMPONENT_STYLES = {
  ...
  contentListItem:
    "bg-white/85 dark:bg-zinc-900/85 border border-white/45 dark:border-white/12 shadow-[0_10px_30px_rgba(0,0,0,0.08)] hover:bg-white/95 dark:hover:bg-zinc-900/95 hover:border-white/60 dark:hover:border-white/20 hover:shadow-[0_14px_36px_rgba(0,0,0,0.12)] rounded-3xl transition-all duration-300 ease-out transform hover:-translate-y-0.5",
  input: {
    mainWrapper: "gap-1",
    inputWrapper:
